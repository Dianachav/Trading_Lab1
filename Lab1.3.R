...
data_iak <- read.csv("/Users/diana/Desktop/Lab1/Copia de ITA_holdings-1.csv", header=TRUE, sep = ",")
primero<-which(x = data_iak[,1]=="Ticker")
ultimo<-length(data_iak[,1])
tk <- data_iak[(primero+2):ultimo-1,1]


##calcular desvest mensual de cada accion que conforma el ETF##
# Cargar el token de QUANDL
Quandl.api_key("oausnohBxGvjUx5puTVQ")
